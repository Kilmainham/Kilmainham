...
// rand variation in emitscale, speed

[CustomEditor(typeof(MegaCacheParticlePro))]
public class MegaCacheParticleProEditor : Editor
{
	...
	[MenuItem("GameObject/Create Other/MegaCache/Particle Pro")]
	static void CreateOBJRef()
	{
		...
		go.AddComponent<MegaCacheParticlePro>();
